 ...
 */
package org.eclipse.buildship.docs.formatting;

import org.eclipse.buildship.docs.source.model.ClassMetaData;
import org.eclipse.buildship.docs.source.model.MethodMetaData;
    ...
    public DocComment parse(ClassMetaData classMetaData, GenerationListener listener) {
        ...
        try {
            ...
            try {
                ...
                throw new RuntimeException(String.format("Could not convert javadoc comment to docbook.%nClass: %s%nComment: %s", classMetaData, rawCommentText), e);
            }
        } finally {
            listener.finish();
        }
    ...
    public DocComment parse(final PropertyMetaData propertyMetaData, final GenerationListener listener) {
        ...
        try {
            ...
            try {
                ...
                throw new RuntimeException(String.format("Could not convert javadoc comment to docbook.%nClass: %s%nProperty: %s%nComment: %s", ownerClass.getClassName(), propertyMetaData.getName(), rawCommentText), e);
            }
        } finally {
            listener.finish();
        }
