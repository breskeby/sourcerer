 ...
 */
package org.eclipse.buildship.docs.source;
...
import org.eclipse.buildship.docs.source.model.*;
...
public class SourceMetaDataVisitor extends VisitorAdapter {
    ...
    public void visitClassDef(GroovySourceAST t, int visit) {
        visitTypeDef(t, visit, ClassMetaData.MetaType.CLASS);
    }

    @Override
    public void visitInterfaceDef(GroovySourceAST t, int visit) {
        visitTypeDef(t, visit, ClassMetaData.MetaType.INTERFACE);
    }

    @Override
    public void visitEnumDef(GroovySourceAST t, int visit) {
        visitTypeDef(t, visit, ClassMetaData.MetaType.ENUM);
    }

    @Override
    public void visitAnnotationDef(GroovySourceAST t, int visit) {
        visitTypeDef(t, visit, ClassMetaData.MetaType.ANNOTATION);
    }
    ...
    private void visitTypeDef(GroovySourceAST t, int visit, ClassMetaData.MetaType metaType) {
        if (visit == OPENING_VISIT) {
            ...
            extractModifiers(t, currentClass);
